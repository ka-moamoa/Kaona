...
{
	[CreateAssetMenu(fileName = nameof(TESTAlphaCharScaleMeshAnimationTEST), menuName = "Audio Text Synchronizer/Text Effects/Mesh/Mesh Animations/" + nameof(TESTAlphaCharScaleMeshAnimationTEST))]
	public class TESTAlphaCharScaleMeshAnimationTEST : MeshAnimationBase
	{
